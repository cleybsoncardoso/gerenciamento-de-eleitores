...
public class GerenciarEleitores extends javax.swing.JPanel {
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        // TODO add your handling code here:
        ArrayList<EleitoresNovo> ordenar = Controller.getInstance().getEleitores();
        Collections.sort(ordenar);
        ArrayList<EleitoresNovo> users = ordenar;
        ArrayList<EleitoresNovo> auxSearch = new ArrayList<EleitoresNovo>();
        for (EleitoresNovo userAtual : users) {
    ...
    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
        ...
        EleitoresNovo selecionada = null;
